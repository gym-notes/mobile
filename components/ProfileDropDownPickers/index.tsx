...
import { IFormData } from '../../screens/ProfileEditScreen';

interface IProfileDropDownPickers {
  control: Control<IFormData>;
  errors: FieldErrors<IFormData>;
}

const ProfileDropDownPickers: React.FC<IProfileDropDownPickers> = ({ control, errors }) => {
...
export default ProfileDropDownPickers;
